...
7. Раздел преподавателя `Аналитика`: группировка по студентам/тестам, детали ответов, экспорт в PDF и Excel.
8. Вход под администратором `admin@test.ru / admin123`.
9. Управление ролями пользователей в администрировании.
